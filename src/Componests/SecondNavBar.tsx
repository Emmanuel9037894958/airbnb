...
function SecondNavBar() {
  ...
  return (
    <section className="">
      <div className="flex gap-7 justify-center pt-12 md:flex md:gap-11 md:justify-center">
        {amazingViewPoint.map((item, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            />
            <a href="">
              <p className="mt-2 hover:text-yellow-700 hover:underline">{item.description}</p>
            </a>
          </div>
        ))}
        <div>
